...
- Macro and micronutrient narration should try to mention the strongest and weakest defensible marks in each section, so sections usually have at least 2 nutrient/submacro points when 2 source-backed values exist; explain what those marks are good or bad for, and for macros also explain why that macro section matters to the specific food type.
