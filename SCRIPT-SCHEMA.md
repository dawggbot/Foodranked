...
- low `starch_g` should not be selected as the spoken carb weakness for food types where low starch is nutritionally normal rather than a real category flaw, including fruits, vegetables, legumes, nuts, seeds, dairy, meats, oils and fats, and misc entries; keep the visible row/arrow stable, and reserve low-starch weakness narration for starch-staple categories such as grains and tubers
