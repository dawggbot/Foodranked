...
- food-type-specific weak-callout exceptions must stay narrow and explicit, not blanket-applied across every food type; current exception: low `starch_g` should not be selected as the spoken carb weakness for fruits because low starch is normal for many fruits, while the visible row/arrow stays stable
