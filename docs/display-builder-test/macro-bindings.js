(function () {
  ...
  window.FOODRANKED_MACRO_BINDINGS = {
    ...
    sources: {
      textBindings: 'docs/display-builder-test/macro-bindings.js',
      arrows: 'docs/display-builder-test/macro-bindings.js row map plus existing display-builder row clustering'
    }
  };
})();
