(function () {
  ...
  function sourceInformation() {
    return {
      ...
      experimentalBindingMap: 'docs/display-builder-test/macro-bindings.js',
      storage: 'reads layout-builder keys only; writes foodranked-display-builder-test-state-v1'
    };
  }
