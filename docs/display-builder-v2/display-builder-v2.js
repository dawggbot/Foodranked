(function () {
  ...
  const DATA_CACHE_BUST = window.FOODRANKED_DATA?.generatedAt || '20260816-data-alignment-v1';
  ...
  function layoutBuilderWorkingOption() {
    ...
    if (isRevokedLayoutSeed(working)) {
      localStorage.removeItem(LAYOUT_BUILDER_WORKING_KEY);
      return null;
    }
  ...
  function outroStaticStampLayers(layout, food) {
    ...
    return [
      ...
      return {
        ...
        y: roundedLayoutNumber(center.y + ctaCenterOffsetY - (OUTRO_CTA_STAMP_SIZE / 2)),
        z: 38 + index,
