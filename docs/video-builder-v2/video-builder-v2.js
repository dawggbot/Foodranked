(function () {
  ...
  const BACKGROUND_MUSIC_VOLUME = 0.126;
  const ARCADE_MELODY_BACKGROUND_MUSIC_VOLUME = BACKGROUND_MUSIC_VOLUME * 0.27;
  ...
  const AVAILABLE_FOOD_IMAGE_IDS = new Set(['bacon', 'black-beans', 'buckwheat', 'chia-seeds', 'cola-regular', 'cranberries', 'feta', 'greek-yogurt', 'hazelnuts', 'kale', 'kefir-plain', 'pork-loin', 'raspberries', 'white-potato']);
  ...
  function backdropPalette(food = selectedFood()) {
    const palettes = window.FOODRANKED_FOOD_TYPE_PALETTES;
